  ...
  return (
    <div className="mb-10">
      ...
      <div className="ml-[46px]">
        ...
        <svg viewBox="0 0 100 2" preserveAspectRatio="none" className="w-full h-[12px] my-10">
  <line x1="0" y1="1" x2="100" y2="1" stroke="#1C2B24" strokeWidth="2" strokeDasharray="6 10" />
</svg>
      </div>
    </div>
  );
