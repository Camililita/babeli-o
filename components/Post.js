...
export default function Post({ user, location, title, poem, avatar }) {
  return (
    <div className="mb-10">
      ...
      <p className="font-bold mt-2 mb-2 uppercase tracking-wide text-[13px]">{title}</p>
      ...
      <hr className="border-t-2 border-dashed border-[#1C2B24]/40 my-10" style={{ borderSpacing: '10px 0' }} />
    </div>
  );
}
